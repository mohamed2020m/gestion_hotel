...
<body>
    ...
    <h1>Hotels by Ville</h1>

    <form action="HotelsByVilleController" method="get">
        <label for="villeId">Select a Ville:</label>
        <select name="villeId">
    ...
    <c:if test="${not empty hotels}">
        <ul>
            <c:forEach items="${hotels}" var="hotel">
                <li>${hotel.nom}, ${hotel.adresse}, ${hotel.telephone}</li>
            </c:forEach>
        </ul>
    </c:if>
	        ...
	        <form id="form_hoteByVille" action="HotelsByVilleController" method="get">
	            <div class="dropdown">
	                ...
	                <ul class="dropdown-menu" aria-labelledby="villeDropdown">
	                    <c:forEach items="${villes}" var="ville">
	                        <li><a href="#" data-id="${ville.id}">${ville.nom}</a></li>
	                    </c:forEach>
	                </ul>
	            </div>
