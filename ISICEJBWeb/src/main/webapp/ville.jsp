		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>
							Gestion de <b>Villes</b>
						</h2>
					</div>
					<div class="col-sm-6">
						<a href=#addVilleModal class="btn btn-success"
				...
				<tbody>
					<c:forEach items="${villes}" var="v">
						...
						<!-- 
							...
							<td>${v.nom}</td>
							<td>
							    <a href="#editVilleModal" class="edit" data-toggle="modal" onclick="setEditVilleData(${v.id}, '${v.nom}')"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
						
							    <a href="#deleteVilleModal" class="delete" data-toggle="modal" onclick="setVilleId(${v.id})"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
	            ...
	            <form action="VilleController" method="post">
	                ...
	                <div class="modal-body">
	                    <div class="form-group">
	                        ...
	                        <input type="text" class="form-control" id="nom" name="ville" required>
	                    </div>
	                </div>
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            <form action="VilleController" method="post">
	                ...
	                <input type="hidden" id="deleteVilleId" name="id">
